...
*/
	...
	public interface IStatusLogger
	{
		...
		void StartLogging(String strOperation, boolean bWriteOperationToLog);
		...
		boolean SetProgress(int uPercent);
		...
		/// <returns>Returns <c>true</c> if the caller should continue
		/// the current work.</returns>
		boolean SetText(String strNewText, LogStatusType lsType);
	...
	class NullStatusLogger implements IStatusLogger
	{
		public void StartLogging(String strOperation, boolean bWriteOperationToLog) { }
		public void EndLogging() { }
		public boolean SetProgress(int uPercent) { return true; }
		public boolean SetText(String strNewText, LogStatusType lsType) { return true; }
		public boolean ContinueWork() { return true; }
	}
